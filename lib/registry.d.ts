...
export declare const Registry: Readonly<{
    ...
    Contract: import("./implementations/scope-registry").Scope;
    LineItem: import("./implementations/scope-registry").Scope;
    LineItemEvent: import("./implementations/scope-registry").Scope;
    OrderEvent: import("./implementations/scope-registry").Scope;
    Term: import("./implementations/scope-registry").Scope;
    QueuedSubscriptionRequest: import("./implementations/scope-registry").Scope;
