...
(function (CheckdigitScopes) {
    ...
    CheckdigitScopes["NewAchGateway"] = "NewAchGateway";
    CheckdigitScopes["NewBankAccount"] = "NewBankAccount";
    CheckdigitScopes["NewBankTransaction"] = "NewBankTransaction";
    CheckdigitScopes["NewBatch"] = "NewBatch";
    CheckdigitScopes["NewOrderReference"] = "NewOrderReference";
    CheckdigitScopes["NewPaymentRequest"] = "NewPaymentRequest";
