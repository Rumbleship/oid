...
exports.Registry = Object.freeze({
    ...
    [scopes_enum_1.CheckdigitScopes.DivisionUser]: oid_1.Oid.RegisterScope(scopes_enum_1.CheckdigitScopes.DivisionUser, 'du'),
    ...
    [scopes_enum_1.CheckdigitScopes.Accrual]: oid_1.Oid.RegisterScope(scopes_enum_1.CheckdigitScopes.Accrual, 'acrl'),
    [scopes_enum_1.CheckdigitScopes.AccrualEvent]: oid_1.Oid.RegisterScope(scopes_enum_1.CheckdigitScopes.AccrualEvent, 'ace'),
    [scopes_enum_1.CheckdigitScopes.JournalEntry]: oid_1.Oid.RegisterScope(scopes_enum_1.CheckdigitScopes.JournalEntry, 'je')
});
