...
describe('Scenario: Experimental Oids can be registered', () => {
    describe('Given: an empty scope registry', () => {
        ...
        describe.each([['Workflow', 'wf', types_1.ScopeTypes.OID], ['PurchaseOrder', 'po', types_1.ScopeTypes.HASHID]])('When: registering a scope for %s, of type %s', (scope, shortcode, scopeType) => {
            let key;
            beforeAll(() => {
