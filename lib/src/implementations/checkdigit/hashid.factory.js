...
const hashids_2 = require("./hashids");
...
class HashidOidFactory {
    static GetHashidOidOptions(scopename) {
        switch (scopename) {
            case hashids_2.HashidScopeNames.Buyer:
                return {
                    shortcode: 'b',
                    checksum: 2,
                    salt: 'Division'
                };
            case hashids_2.HashidScopeNames.Supplier:
                return {
                    shortcode: 's',
                    checksum: 2,
                    salt: 'Division'
                };
            case hashids_2.HashidScopeNames.User:
                return {
                    shortcode: 'u',
                    checksum: 2,
                    salt: 'User'
                };
            case hashids_2.HashidScopeNames.PurchaseOrder:
                return {
                    shortcode: 'po',
                    checksum: 3,
                    salt: 'purchaseOrder'
                };
            case hashids_2.HashidScopeNames.Shipment:
                return {
                    shortcode: 'shp',
                    checksum: 5,
                    salt: 'shipment'
